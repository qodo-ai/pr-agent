...
from pr_agent.tools.ticket_pr_compliance_check import extract_tickets_link_from_branch_name
...
class TestExtractTicketsLinkFromBranchName:
    ...
    def test_empty_branch_returns_empty(self):
        """Empty branch name -> []"""
        result = extract_tickets_link_from_branch_name("", "org/repo")
        assert result == []

    def test_none_branch_returns_empty(self):
        """None branch name -> []"""
        result = extract_tickets_link_from_branch_name(None, "org/repo")
        assert result == []
    ...
    def test_empty_repo_path_returns_empty(self):
        ...
        result = extract_tickets_link_from_branch_name("feature/1-test", "", "https://github.com")
        assert result == []
