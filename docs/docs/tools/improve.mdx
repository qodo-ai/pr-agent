...
<Tabs>
<TabItem value="suggestions-overview" label="Suggestions Overview">

<img src="https://codium.ai/images/pr_agent/code_suggestions_as_comment_closed.png" alt="code_suggestions_as_comment_closed" width="512" />

</TabItem>
<TabItem value="selecting-a-specific-suggestion" label="Selecting a specific suggestion">

<img src="https://codium.ai/images/pr_agent/code_suggestions_as_comment_open.png" alt="code_suggestions_as_comment_open" width="512" />
...
<img src="https://codium.ai/images/pr_agent/improve.png" alt="improve" width="512" />
...
<img src="https://codium.ai/images/pr_agent/code_suggestions_as_comment_closed.png" alt="code_suggestions_as_comment_closed.png" width="512" />
...
Our recommended approach for presenting code suggestions is through a [table](./improve.mdx#overview) (`--pr_code_suggestions.commitable_code_suggestions=false`).
...
<img src="https://codium.ai/images/pr_agent/self_review_1.png" alt="self_review_1" width="512" />
...
<img src="https://codium.ai/images/pr_agent/self_review_2.png" alt="self_review_2" width="512" />
...
- **Customization:** To guide the model to suggestions that are more relevant to the specific needs of your project, we recommend using the [`extra_instructions`](./improve.mdx#extra-instructions-and-best-practices) and [`best practices`](./improve.mdx#best-practices) fields.
