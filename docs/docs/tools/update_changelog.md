...
Under the section `pr_update_changelog`, the [configuration file](https://github.com/qodo-ai/pr-agent/blob/main/pr_agent/settings/configuration.toml#L180) contains options to customize the 'update changelog' tool:
