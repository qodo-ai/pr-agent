...
The possible configurations of PR-Agent are stored in [here](https://github.com/Codium-ai/pr-agent/blob/main/pr_agent/settings/configuration.toml){:target="_blank"}.
...
You can view the list of auto-generated file patterns in [`generated_code_ignore.toml`](https://github.com/Codium-ai/pr-agent/blob/main/pr_agent/settings/generated_code_ignore.toml).
