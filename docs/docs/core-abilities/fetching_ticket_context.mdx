...
<img src="https://www.qodo.ai/images/pr_agent/ticket_compliance_review.png" alt="Ticket Compliance" width="768" />
...
<details>
<summary>Script to validate basic auth</summary>
...
<details open>
<summary>Script to validate PAT token</summary>
...
<Tabs>
<TabItem value="email-token-(basic-auth)" label="Email/Token (Basic Auth)">
...
<TabItem value="pat-auth" label="PAT Auth">
